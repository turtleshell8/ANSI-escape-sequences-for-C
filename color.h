 ...
 *
 * dev here for full transparency i just modified this ansi escape sequences header
 * i got from GitHub to make it work for windows or my computer atleast and its
 * unlicensed so yippe no unlicenseign issues but i cant find the github repo with 
 * the original header i dont know if it changed or got delleted but either way enjoy
 */

//Regular text
#define KBLK "\033[0;30m"
